...
* Mapping of gestures to media controls works and makes sense
    * a time-threshold would be good for start/stop (0.5P)
* Low latency between gesture and the systems reaction
    * yep (1P)

## Code Quality (-0.5P)
* we had to install python 3.11 and delete things out of the requirements.txt, so we could test it after 30 minutes 